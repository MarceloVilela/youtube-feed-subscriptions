import {
  storeJson as storeJsonBin,
  loadJson as loadJsonBin,
} from "./json/jsonbin";
import {
  storeJson as storeJsonLocal,
  loadJson as loadJsonLocal,
} from "./json/local";
import {
  storeJson as storeJsonDebug,
  loadJson as loadJsonDebug,
} from "./json/debug";
